  ...
  return (
    <div className='bg-custom-blue py-5 px-4'>
      <div className='flex flex-col md:flex-row items-center justify-between'>
        {/* Social media icons on the right in desktop view */}
        <div className='md:text-right md:order-2 flex gap-4 md:mt-0 mt-4'>
          <FaYoutube className='text-white' size={28} />
          <FaInstagram className='text-white' size={28} />
          <FaTwitter className='text-white' size={28} />
        </div>

        {/* List items (ul) on the left in desktop view */}
